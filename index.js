...
client.on('message', msg => {  
  if (msg.guild.members.filter(mem => mem.username.startsWith("!"))) {
    mem.setNickname(`${mem.username.substr(2, 100)}`, `Changed ${mem.username}#${mem.user.tag}'s nickname for hoisting.`)
  }
