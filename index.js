...
client.on('message', msg => {  
  if (msg.guild.members.filter(mem => mem.user.username.startsWith("!")).then(setNickname(`${msg.guild.member.username.substr(2, 100)}`, `Attempting to hoist on the user list.`)))
