...
client.on('message', msg => {
  if (msg.guild.members.nickname.startsWith("!")) {
    msg.guild.member.setNickname(`${msg.member.username.substr(2, 100)}`, `This user was hoisting so I changed their nickname!`)
  }
